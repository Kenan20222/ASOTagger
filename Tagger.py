...
async def mentionall(event):
  ...
  if event.pattern_match.group(1):
    ...
    return await event.respond("Başlamaq üçün Səbəb Yazın @blackmafiaqrup 🇦🇿")
  else:
...
print(">> Bot işləyir artıq 🚀 @qartalamucalarda bilgi alabilirsin <<")
